        ...
        child: Container(
          ...
          child: Column(
            crossAxisAlignment: isImage
                ? CrossAxisAlignment.end // الصور دائمًا محاذاة لليمين للوقت
                : isArabicText
                    ? CrossAxisAlignment.end // النصوص العربية محاذاة لليمين
                    : CrossAxisAlignment
                        .start, // النصوص الإنجليزية محاذاة لليسار
            children: [
              if (isImage)
                ClipRRect(
                  borderRadius: BorderRadius.circular(8),
              ...
              Row(
                ...
                textDirection: TextDirection.ltr, // اتجاه من اليسار إلى اليمين
                children: [
                  Text(
                    _formatTime(widget.message['time']),
                    style: TextStyle(
