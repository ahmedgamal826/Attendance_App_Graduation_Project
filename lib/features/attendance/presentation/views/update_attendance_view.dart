...
// //             // حقل البريد الإلكتروني (يمكن جعله قراءة فقط)
// //             TextField(
...
// //             ElevatedButton(
// //               onPressed: () {
// //                 // إنشاء خريطة محدثة لبيانات الطالب
// //                 Map<String, String> updatedStudent = {
// //                   'name': nameController.text,
// //                   'email': widget.student['email']!, // لا يتغير
// //                   'image': widget.student['image']!, // تبقى الصورة كما هي
// //                 };
// //                 // العودة إلى الصفحة السابقة مع البيانات المُحدثة
...
//   /// وإرجاع رابط التحميل (Download URL)
...
//     // خريطة جديدة للبيانات المحدثة
//     Map<String, dynamic> updatedStudent = {
//       'name': nameController.text,
//       'email':
//           emailController.text, // يمكن للمستخدم تغيير البريد الإلكتروني أيضاً
//       'image': oldImageUrl ?? '', // الصورة القديمة بشكل افتراضي
//     };

//     // إذا اختار المستخدم صورة جديدة
//     if (_newImageFile != null) {
//       // ارفع الصورة إلى Firebase Storage واحصل على الرابط
//       String newImageUrl = await _uploadImage(_newImageFile!);
//       updatedStudent['image'] = newImageUrl;
//     }

//     // الرجوع إلى الصفحة السابقة مع البيانات المحدثة
//     Navigator.pop(context, updatedStudent);
//   }
