...
// // //                       // Score info (specific to student view)
// // //                       Padding(
...
// //   final TestModel test;
// //   final VoidCallback onTap;
// //   final VoidCallback onViewSubmissions; // إضافة callback لعرض التقديمات

// //   const TestListItem({
// //     Key? key,
// //     required this.test,
// //     required this.onTap,
// //     required this.onViewSubmissions, // إضافة المعامل الجديد
// //   }) : super(key: key);
...
class TestListItem extends StatefulWidget {
  final TestModel test;
  final VoidCallback onTap;
  final VoidCallback onViewSubmissions; // Callback لعرض التقديمات

  const TestListItem({
    Key? key,
    required this.test,
    required this.onTap,
    required this.onViewSubmissions, // المعامل الجديد
  }) : super(key: key);
