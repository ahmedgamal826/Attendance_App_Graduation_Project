...
import 'package:attendance_app/features/assignments/presentation/viewmodels/assignment_viewmodel.dart';
import 'package:attendance_app/features/assignments/presentation/views/add_questions_view.dart';
import 'package:attendance_app/features/assignments/presentation/views/widgets/question_card.dart';
import 'package:attendance_app/features/assignments/presentation/views/widgets/question_content.dart';
import 'package:awesome_dialog/awesome_dialog.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class AdminAssignmentView extends StatelessWidget {
  final List<Map<String, dynamic>> initialQuestions;
  final String courseId;

  const AdminAssignmentView({
    Key? key,
  ...
  void _showQuestionTypeDialog(
      BuildContext context, AssignmentViewModel viewModel) {
    showDialog(
      context: context,
  ...
  Widget _buildQuestionTypeButton(
      BuildContext context, String type, AssignmentViewModel viewModel) {
  ...
  void _showDeleteDialog(
      BuildContext context, int index, AssignmentViewModel viewModel) {
    AwesomeDialog(
      context: context,
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) {
        final viewModel = AssignmentViewModel();
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: FloatingActionButton(
                    heroTag: "admin_assignment_screen",
                    onPressed: () {
