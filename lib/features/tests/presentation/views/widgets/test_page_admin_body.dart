import 'dart:math';
import 'package:attendance_app/features/tests/cubit/cubit_admin/test_cubit.dart';
import 'package:attendance_app/features/tests/cubit/cubit_admin/test_state.dart';
import 'package:attendance_app/features/tests/presentation/views/test_page_details_2_admin.dart';
...
class _TestPageAdminBodyState extends State<TestPageAdminBody>
  ...
  void _navigateToAssessmentPage(BuildContext context, String assignmentTitle) {
    Navigator.push(
      context,
      MaterialPageRoute(
            ...
            itemBuilder: (context, index) {
              ...
              return TestListItem(
                ...
                onTap: () {
                  ...
                  if (state.tests[index].name == 'Test 2') {
