...
class TestsTestsFileUploadWidget extends StatefulWidget {
  final Function(File file, String fileName) onFileSelected;
  final String? initialFileName;

  const TestsTestsFileUploadWidget({
    Key? key,
  ...
  @override
  State<TestsTestsFileUploadWidget> createState() =>
      Tests_TestsTestsFileUploadWidgetState();
}

class Tests_TestsTestsFileUploadWidgetState
    extends State<TestsTestsFileUploadWidget> {
