import 'package:attendance_app/features/tests/presentation/views/widgets/test_page_details_student_body.dart';
...
class TestPageDetailsStudent extends StatefulWidget {
  ...
  const TestPageDetailsStudent({Key? key, required this.assignmentTitle})
      : super(key: key);
